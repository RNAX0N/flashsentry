...
bool HidDeviceMonitor::initializeUdev() { return true; }
void HidDeviceMonitor::cleanupUdev() {}
void HidDeviceMonitor::scanExistingDevices() { emit initialScanComplete(0); }
void HidDeviceMonitor::processUdevEvent(struct udev_device* /*dev*/) {}
bool HidDeviceMonitor::isUsbHidInput(struct udev_device* /*dev*/) const { return false; }
HidDeviceInfo HidDeviceMonitor::extractDeviceInfo(struct udev_device* /*dev*/) const { return {}; }
struct udev_device* HidDeviceMonitor::getUsbDeviceParent(struct udev_device* /*dev*/) const { return nullptr; }
struct udev_device* HidDeviceMonitor::getUsbInterfaceParent(struct udev_device* /*dev*/) const { return nullptr; }
QString HidDeviceMonitor::getProperty(struct udev_device* /*dev*/, const char* /*key*/) const { return {}; }
QString HidDeviceMonitor::getSysAttr(struct udev_device* /*dev*/, const char* /*key*/) const { return {}; }
